...
public class YoutubeTest {
	...
	public static void main(String[] args) {
		...
		List<YoutubeMetaData> recordContainer = youtubeApiClient
				.youtubeSongSearch(5, recordTitle, bandMid);
		List<YoutubeMetaData> trackContainer = youtubeApiClient
				.youtubeSongSearch(5, trackTitle, bandMid);
		List<YoutubeMetaData> searchTermContainer = youtubeApiClient
				.youtubeSongSearch(5, trackTitle);
		List<YoutubeMetaData> searchTopicContainer = youtubeApiClient
				.youtubeSongSearch(5, bandMid);
